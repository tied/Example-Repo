...
@Named
public class PlanVsActual extends AbstractChartReport {
	private static final Logger log = LoggerFactory.getLogger(PlanVsActual.class);
	private final ChartFactory chartFactory;
	private final TimeZoneManager timeZoneManager;

	@Inject
	public PlanVsActual(@ComponentImport JiraAuthenticationContext authenticationContext,
